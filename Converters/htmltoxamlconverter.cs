...
namespace Re_useable_Classes.Converters
{
    ...
    public static class HtmlToXamlConverter
    {
        ...
        private const string XamlHyperlinkNavigateUri = "NavigateUri";
        private const string XamlHyperlinkTargetName = "TargetName";
        private const string XamlSection = "Section";
        private const string XamlList = "List";
        private const string XamlListMarkerStyle = "MarkerStyle";
        private const string XamlListMarkerStyleNone = "None";
        private const string XamlListMarkerStyleDecimal = "Decimal";
        private const string XamlListMarkerStyleDisc = "DiStockControl";
        private const string XamlListMarkerStyleCircle = "Circle";
        private const string XamlListMarkerStyleSquare = "Square";
        private const string XamlListMarkerStyleBox = "Box";
        private const string XamlListMarkerStyleLowerLatin = "LowerLatin";
        private const string XamlListMarkerStyleUpperLatin = "UpperLatin";
        private const string XamlListMarkerStyleLowerRoman = "LowerRoman";
        private const string XamlListMarkerStyleUpperRoman = "UpperRoman";
        private const string XamlListItem = "ListItem";
        private const string XamlLineBreak = "LineBreak";
        private const string XamlParagraph = "Paragraph";
        private const string XamlMargin = "Margin";
        private const string XamlPadding = "Padding";
        private const string XamlBorderBrush = "BorderBrush";
        private const string XamlBorderThickness = "BorderThickness";
        private const string XamlTable = "Table";
        private const string XamlTableColumn = "TableColumn";
        private const string XamlTableRowGroup = "TableRowGroup";
        private const string XamlTableRow = "TableRow";
        private const string XamlTableCell = "TableCell";
        private const string XamlTableCellBorderThickness = "BorderThickness";
        private const string XamlTableCellBorderBrush = "BorderBrush";
        private const string XamlTableCellColumnSpan = "ColumnSpan";
        private const string XamlTableCellRowSpan = "RowSpan";
        private const string XamlWidth = "Width";
        private const string XamlBrushesBlack = "Black";
        private const string XamlFontFamily = "FontFamily";
        private const string XamlFontSize = "FontSize";
        private const string XamlFontSizeXxLarge = "22pt"; // "XXLarge";
        private const string XamlFontSizeXLarge = "20pt"; // "XLarge";
        private const string XamlFontSizeLarge = "18pt"; // "Large";
        private const string XamlFontSizeMedium = "16pt"; // "Medium";
        private const string XamlFontSizeSmall = "12pt"; // "Small";
        private const string XamlFontSizeXSmall = "10pt"; // "XSmall";
        private const string XamlFontSizeXxSmall = "8pt"; // "XXSmall";
        private const string XamlFontWeight = "FontWeight";
        public const string XamlFontWeightBold = "Bold";
        private const string XamlFontStyle = "FontStyle";
        public const string XamlForeground = "Foreground";
        public const string XamlBackground = "Background";
        private const string XamlTextDecorations = "TextDecorations";
        private const string XamlTextDecorationsUnderline = "Underline";
        private const string XamlTextIndent = "TextIndent";
        private const string XamlTextAlignment = "TextAlignment";
            ...
            bool asFlowDocument)
        {
            ...
            XmlElement xamlFlowDocumentElement = xamlTree.CreateElement
                (
                    null,
                    rootElementName,
                    XamlNamespace);
            ...
            xamlFlowDocumentElement.SetAttribute
                (
                    "xml:space",
                    "preserve");
        ...
        {
            var node = htmlNode as XmlComment;
            if (node != null)
            {
            ...
            List<XmlElement> sourceContext)
        {
            ...
            else
            {
                ...
                Hashtable currentProperties = GetElementProperties
                    (
                        htmlElement,
                        inheritedProperties,
                        out localProperties,
                ...
                if (xamlParentElement.OwnerDocument != null)
                {
                    ...
                    for (XmlNode htmlChildNode = htmlElement.FirstChild;
                         htmlChildNode != null;
                         htmlChildNode = htmlChildNode != null
                                             ? htmlChildNode.NextSibling
                                             : null)
                    {
                        htmlChildNode = AddBlock
                            (
                                xamlElement,
                                htmlChildNode,
                                currentProperties,
            ...
            List<XmlElement> sourceContext)
        {
            ...
            {
                var element = htmlNode as XmlElement;
                if (element != null)
                {
                    XmlElement htmlElement = element;
            ...
            List<XmlElement> sourceContext)
        {
            ...
            for (XmlNode htmlNode = htmlElement.FirstChild;
                 htmlNode != null;
                 htmlNode = htmlNode.NextSibling)
            {
                ...
                if (!HtmlSchema.IsInlineElement(htmlChildName) && !HtmlSchema.IsBlockElement(htmlChildName) &&
                    htmlChildName != "img" && htmlChildName != "br" && htmlChildName != "SelectHR")
                {
                    continue;
                }
            ...
            string xamlElementName = elementHasChildren
                                         ? XamlSpan
                                         : XamlRun;
            ...
            string textData)
        {
            if (xamlElement == null)
            {
                throw new ArgumentNullException("xamlElement");
            }
            ...
            if (xamlElement.OwnerDocument != null)
            {
            ...
            List<XmlElement> sourceContext)
        {
            ...
            else
            {
                ...
                if (xamlParentElement.OwnerDocument != null)
                {
                    ...
                    if (hrefParts.Length > 0 && hrefParts[0].Trim()
                                                            .Length > 0)
                    {
                        xamlElement.SetAttribute
                            (
                                XamlHyperlinkNavigateUri,
                                hrefParts[0].Trim());
                    }
                    if (hrefParts.Length == 2 && hrefParts[1].Trim()
                                                             .Length > 0)
                    {
                        xamlElement.SetAttribute
                            (
                                XamlHyperlinkTargetName,
                                hrefParts[1].Trim());
                    }
            ...
            XmlElement xamlParentElement)
        {
            if (htmlComment == null)
            {
                throw new ArgumentNullException("htmlComment");
            }
        ...
        private static XmlElement ExtractInlineFragment(XmlElement xamlFlowDocumentElement)
        {
            if (_inlineFragmentParentElement != null)
            {
                ...
                {
                    if (xamlFlowDocumentElement.OwnerDocument != null)
                    {
        ...
        private static void AddImage
            ...
            List<XmlElement> sourceContext)
        {
            if (xamlParentElement == null)
            {
                throw new ArgumentNullException("xamlParentElement");
            }
            if (htmlElement == null)
            {
            ...
            {
                throw new ArgumentNullException("inheritedProperties");
            }
            if (stylesheet == null)
            {
            ...
            List<XmlElement> sourceContext)
        {
            ...
            XmlElement xamlListElement = xamlParentElement.OwnerDocument.CreateElement
                (
                    null,
                    XamlList,
                    XamlNamespace);
            ...
            xamlListElement.SetAttribute
                (
                    XamlListMarkerStyle,
                    htmlListElementName == "ol"
                        ? XamlListMarkerStyleDecimal
                        : XamlListMarkerStyleDisc);
            ...
            List<XmlElement> sourceContext)
        {
            ...
            XmlElement xamlListElement = null;
            ...
            else
            {
                ...
                if (xamlParentElement.OwnerDocument != null)
                {
                    xamlListElement = xamlParentElement.OwnerDocument.CreateElement
                        (
                            null,
                            XamlList,
                            XamlNamespace);
                }
                if (xamlListElement != null)
                {
                    xamlParentElement.AppendChild(xamlListElement);
                }
            }
            ...
            List<XmlElement> sourceContext)
        {
            ...
            if (xamlListElement.OwnerDocument == null)
            {
                return;
            }
            XmlElement xamlListItemElement = xamlListElement.OwnerDocument.CreateElement
                (
                    null,
                    XamlListItem,
                    XamlNamespace);
            ...
            List<XmlElement> sourceContext)
        {
            ...
            else
            {
                ...
                if (xamlParentElement.OwnerDocument != null)
                {
                    XmlElement xamlTableElement = xamlParentElement.OwnerDocument.CreateElement
                        (
                            null,
                            XamlTable,
                            XamlNamespace);
                    ...
                    ArrayList columnStarts = AnalyzeTableStructure
                        (
                            htmlTableElement,
                            stylesheet);
        ...
        private static XmlElement GetCellFromSingleCellTable(XmlNode htmlTableElement)
        {
                 ...
                 tableChild = tableChild.NextSibling)
            {
                ...
                if (elementName == "tbody" || elementName == "thead" || elementName == "tfoot")
                {
                    ...
                    {
                        switch (tbodyChild.LocalName.ToLower())
                        {
                            case "tr":
                                if (singleCell != null)
                                {
                ...
                else if (tableChild.LocalName.ToLower() == "tr")
                {
                    ...
                    for (XmlNode trChild = tableChild.FirstChild;
                         trChild != null;
                         trChild = trChild.NextSibling)
                    {
                        string cellName = trChild.LocalName.ToLower();
        ...
        private static void AddColumnInformation
            (
            XmlNode htmlTableElement,
            XmlElement xamlTableElement,
            IList columnStartsAllRows,
            ...
            List<XmlElement> sourceContext)
        {
            ...
            if (columnStartsAllRows != null)
            {
                ...
                for (int columnIndex = 0;
                     columnIndex < columnStartsAllRows.Count - 1;
                     columnIndex++)
                {
                    if (xamlTableElement.OwnerDocument == null)
                    {
                    ...
                    XmlElement xamlColumnElement = xamlTableElement.OwnerDocument.CreateElement
                        (
                            null,
                            XamlTableColumn,
                            XamlNamespace);
            ...
            List<XmlElement> sourceContext)
        {
            ...
            for (XmlNode htmlNode = htmlColgroupElement.FirstChild;
                 htmlNode != null;
                 htmlNode = htmlNode.NextSibling)
            {
            ...
            List<XmlElement> sourceContext)
        {
            ...
            XmlElement xamlTableColumnElement = xamlTableElement.OwnerDocument.CreateElement
                (
                    null,
                    XamlTableColumn,
                    XamlNamespace);
        ...
        private static XmlNode AddTableCellsToTableRow
            (
            XmlNode xamlTableRowElement,
            XmlNode htmlTdStartNode,
            Hashtable currentProperties,
            ArrayList columnStarts,
            IList activeRowSpans,
            CssStylesheet stylesheet,
            List<XmlElement> sourceContext)
        {
            if (xamlTableRowElement == null)
            {
                throw new ArgumentNullException("xamlTableRowElement");
            }
            // parameter validation
                   ...
                   htmlChildNode.LocalName.ToLower() != "tfoot")
            {
                if (htmlChildNode.LocalName.ToLower() == "td" || htmlChildNode.LocalName.ToLower() == "th")
                {
                    ...
                    {
                        XmlElement xamlTableCellElement = xamlTableRowElement.OwnerDocument.CreateElement
                            (
                                null,
                                XamlTableCell,
                                XamlNamespace);
                        ...
                        if (columnStarts != null)
                        {
                            ...
                            xamlTableCellElement.SetAttribute
                                (
                                    XamlTableCellColumnSpan,
                                    columnSpan.ToString(CultureInfo.InvariantCulture));
        ...
        /// </summary>
        /// <param name="htmlTableElement"></param>
        /// <param name="stylesheet"></param>
        /// <returns>
            ...
            // ReSharper restore FunctionRecursiveOnAllPaths
        {
            try
            {
                ...
                {
                    throw new ArgumentNullException("htmlTableElement");
                }
                if (stylesheet == null)
                {
                    throw new ArgumentNullException("stylesheet");
            ...
            while (htmlChildNode != null && columnWidthsAvailable)
            {
                ...
                switch (htmlChildNode.LocalName.ToLower())
                {
                    case "tbody":
                        ...
                        double tbodyWidth = AnalyzeTbodyStructure
                            (
                                htmlChildNode,
                                columnStarts,
                                activeRowSpans,
                        ...
                        else if (Math.Abs(tbodyWidth - 0) < epsilon)
                        {
                    ...
                    case "tr":
                        ...
                        else if (Math.Abs(trWidth - 0) < epsilon)
                        {
                            columnWidthsAvailable = false; // interrupt the analisys
                        }
                        break;
            ...
            CssStylesheet stylesheet)
        {
            ...
            double trWidth = columnWidthsAvailable
                                 ? columnStart
                                 : 0;
        ...
        private static int GetRowSpan(XmlElement htmlTdElement)
        {
            ...
            string rowSpanAsString = GetAttribute
                (
                    htmlTdElement,
                    "rowspan");
        ...
        {
            for (int columnIndex = 0;
                 columnIndex < activeRowSpans.Count;
                 columnIndex++)
            {
        ...
        /// </param>
        private static void InitializeActiveRowSpans
            (
            IList activeRowSpans,
            int count)
        {
        ...
        /// </param>
        private static double GetNextColumnStart
            (
            XmlElement htmlTdElement,
            double columnStart)
        {
            // Parameter validation
        ...
        private static double GetColumnWidth(XmlElement htmlTdElement)
        {
            ...
            string columnWidthAsString = GetAttribute
                                             (
                                                 htmlTdElement,
                                                 "width") ??
                                         GetCssAttribute
            ...
            const double epsilon = 0;
            if (!TryGetLengthValue
                     (
                         columnWidthAsString,
                         out columnWidth) || Math.Abs(columnWidth - 0) < epsilon)
            {
                columnWidth = -1;
            }
            return columnWidth;
        ...
        /// </param>
        private static void VerifyColumnStartsAscendingOrder(IEnumerable columnStarts)
        {
            Debug.Assert(columnStarts != null);
        ...
        private static Hashtable GetElementProperties
            (
            XmlElement htmlElement,
            IDictionary inheritedProperties,
        ...
        /// </returns>
        private static string GetCssAttribute
            (
            string cssStyle,
            string attributeName)
        {
        ...
        /// <returns></returns>
        private static bool TryGetLengthValue
            (
            ...
            out double length)
        {
            ...
            {
                lengthAsString = lengthAsString.Trim()
                                               .ToLower();
                ...
                {
                    lengthAsString = lengthAsString.Substring
                        (
                            0,
            ...
            XmlElement xamlTableCellElement)
        {
            ...
            xamlTableCellElement.SetAttribute
                (
                    XamlTableCellBorderThickness,
                    "1,1,1,1");
            xamlTableCellElement.SetAttribute
                (
                    XamlTableCellBorderBrush,
                    XamlBrushesBlack);
            string rowSpanString = GetAttribute
                (
                    htmlChildNode,
                    "rowspan");
