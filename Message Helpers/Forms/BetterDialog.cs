            ...
            Image iconSet)
        {
            ...
            using (Graphics graphics = CreateGraphics())
            {
                    ...
                    if (SystemFonts.MessageBoxFont.FontFamily.Name == "Segoe UI")
                    {
                        ...
                        label1.ForeColor = Color.FromArgb
                            (
                                0,
                                51,
                                153); // [ColorTranslator.FromHtml("#003399")]
                        ...
                        smallSize = graphics.MeasureString
                            (
                                smallExplanation,
                                Font,
                                label2.Width);
                        bigSize = graphics.MeasureString
                            (
                                largeHeading,
                                label1.Font,
                                label1.Width);
                        ...
                        pictureBox1.Margin = new Padding
                            (
                            pictureBox1.Margin.Left,
                            pictureBox1.Margin.Top + 6,
                            pictureBox1.Margin.Right,
                ...
                else
                {
                    ...
                    Height = tableLayoutPanel1.Height + 71;
